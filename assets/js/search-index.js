window.SEARCH_INDEX = {
  ...
  "notes": [
    ...
    {
      "id": "estado-coherente-fononico-bloque-polaritonico",
      "title": "Estado coherente fonónico en bloque polaritónico",
      "url": "doctorado/optica-cuantica/estado-coherente-fononico-bloque-polaritonico.html",
      "stage": "Doctorado",
      "area": "Óptica cuántica",
      "tags": [
        "Holstein-Cummings",
      ...
      "summary": "Dinámica del bloque polaritónico n=9 con un estado coherente fonónico: aproximación lineal, paquetes contrarrotantes, tiempo de revival, solución efectiva exacta y comparación con el hamiltoniano HC completo.",
      "results": [
        "t_r=4 pi Omega_nM^ef/(nu^2 lambda^2) y t_r^R=4 pi sqrt(M)/(nu lambda)",
        "W_polaritonica lineal a partir del traslape de dos paquetes coherentes",
        "W_electronica lineal=2 Re <chi_+|chi_-> y W_R,lineal=0",
        "W_polaritonica efectiva exacta como suma de Poisson sobre m",
        "W_electronica exacta por interferencia entre p_(9,m+1)^+ y p_(9,m)^-",
        "Fidelidad cercana a uno entre el hamiltoniano efectivo y el HC completo"
      ],
